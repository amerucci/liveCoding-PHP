...
foreach ($liste as $element) {
  echo '
        <tr>
        <th scope="col">' . $element["nom_commune"] . '</th>
        <th scope="col">' . $element["cp_commune"] . '</th>
        <th scope="col">' . $element["population_commune"] . '</th>
        <th scope="col">' . $element["nom_departement"] . '</th>
        <th scope="col">' . $element["nom_region"] . '</th>
